...
class MenuBottomsheet extends StatefulWidget {
  ...
  Menuitem? menuItem;
  MenuBottomsheet({super.key,this.menuItem});
...
class _MenuBottomsheetState extends State<MenuBottomsheet> {
  ...
  void initState() {
    ...
    setState(() {
       ...
       widget.menuItem?.ingredients?.clear();
       widget.menuItem?.size?.clear();
       widget.menuItem?.categories?.clear();
    });
...
//                                 }
//                               },
//                               controller: categorycontroller[index],decoration: InputDecoration(
//                               border:OutlineInputBorder(borderRadius: BorderRadius.circular(size.width*0.2)
//                               ),),))),
//                               SizedBox(width: size.width*0.07,),
//                               Align(child: Container(width: size.width*0.2,child: TextFormField(
...
//                              IconButton(onPressed: () => setState(() {
//                                categorycontroller.remove(categorycontroller[index]);
                               
//                              }), icon: Icon(Icons.delete))
//                            ],
//                          ),
//                          SizedBox(height: size.height*0.02,),
//                    categorycontroller[index] == categorycontroller.last ? IconButton(onPressed: () => 
//                      setState(() {
//                        categorycontroller.insert(index+1, TextEditingController());
